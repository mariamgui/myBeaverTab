(function(){
  ...
  function sayHi() {
    swal("A reminder for tokens", "Hello Friend, if you like this plugin please help us get a better grade by CLICKING on the YELLOW link on the NAVBAR ONCE A DAY. Sign in with your ONID and fill out the form. Once you generate a token which is really just a set of unique characters. We automatically get a point which proves that you used our plugin today.We need to reach 200 points so every single point is valuable :) Thank you!", "info");
  }
