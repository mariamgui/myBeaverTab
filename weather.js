...
function build_weather_codes(){
	...
	weather_index["showers_in_vic"] = ["shra.svg", "shra.svg", "Showers in Vicinity | Showers in Vicinity Fog/Mist | Showers in Vicinity Fog | Showers in Vicinity Haze"];
	weather_index["freezing_rain_rain"] = ["raip.svg", "nraip.svg", "Freezing Rain Rain | Light Freezing Rain Rain | Heavy Freezing Rain Rain | Rain Freezing Rain | Light Rain Freezing Rain | Heavy Rain Freezing Rain | Freezing Drizzle Rain | Light Freezing Drizzle Rain | Heavy Freezing Drizzle Rain | Rain Freezing Drizzle | Light Rain Freezing Drizzle | Heavy Rain Freezing Drizzle"];
	weather_index["thunderstorm_in_vic"] = ["tsra.svg", "tsra.svg", "Thunderstorm in Vicinity | Thunderstorm in Vicinity Fog | Thunderstorm in Vicinity Haze"];
	...
	weather_index["rain"] = ["ra.svg", "nra.svg", "Rain | Heavy Rain | Rain Fog/Mist | Heavy Rain Fog/Mist | Rain Fog | Heavy Rain Fog"];
	weather_index["funnel_cloud"] = ["nsvrtsra.svg", "nsvrtsra.svg", "Funnel Cloud | Funnel Cloud in Vicinity | Tornado/Water Spout"];
	weather_index["dust"] = ["fg.svg", "fg.svg", "Dust | Low Drifting Dust | Blowing Dust | Sand | Blowing Sand | Low Drifting Sand | Dust/Sand Whirls | Dust/Sand Whirls in Vicinity | Dust Storm | Heavy Dust Storm | Dust Storm in Vicinity | Sand Storm | Heavy Sand Storm | Sand Storm in Vicinity"];
	weather_index["haze"] = ["fg.svg", "fg.svg", "Haze"];
...
function get_weather_image(w){
	...
	if (!(w_type in weather_inv_map)) {
		return "<img src =\"./wic/unkn.svg\" class =\"wicon\">"	
	}

	var icon_name = weather_inv_map[w_type][1];
	var hour = (new Date()).getHours()
	if (hour>= 19 || hour <=5) {
		icon_name = weather_inv_map[w_type][2];
	}	
